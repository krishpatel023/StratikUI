    ...
    <div className="w-full px-4 @md:px-16 py-12  text-foreground grid grid-cols-4 gap-12">
      <div className="col-span-4 flex flex-col gap-4 items-center text-center @md:items-start @md:text-start">
        ...
        <span className="text-secondary-foreground">
          This is the best UI library in the world. This claim is backed by the community and John Doe. Build something
          awesome.
        </span>
        <SocialMedia />
      </div>
      {LinksData.map((data) => (
        <div className="flex flex-col gap-2 col-span-4 items-center @md:col-span-1 @md:items-start" key={data.title}>
      ...
      <div className="col-span-4 min-w-full bg-outline-secondary min-h-px" />

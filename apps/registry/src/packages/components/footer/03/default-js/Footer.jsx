import { ThemeToggle } from "@/packages/primitives/theme-toggles/01/react_aria-js/ThemeToggle";
...
export function Footer() {
  ...
  return (
    <div className="w-full px-4 @md:px-16 py-12  text-foreground grid grid-cols-4 gap-12">
      ...
      {LinksData.map((data) => (
        <div
          className="flex flex-col gap-2 col-span-4 items-center @md:col-span-1 @md:items-start"
          key={data.title}
        >

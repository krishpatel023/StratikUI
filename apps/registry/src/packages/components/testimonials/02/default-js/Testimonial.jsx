...
export function Testimonial() {
  return (
    <div className="w-full relative px-10 py-2">
      <h1 className="text-3xl font-semibold text-primary-foreground text-center mb-2">Testimonials</h1>
      ...
      <div className="w-full grid grid-cols-1 @md:grid-cols-3 @lg:grid-cols-4 gap-4">
        <Card>
          ...
          <p className="font-medium text-s_textSecondary mt-6">
            ...
            time to fully utilize all the tools available.
          </p>
          <h1 className="text-xl font-semibold text-s_textPrimary mt-6">John Doe</h1>
        ...
        <Card className="@md:col-span-2 ">
          ...
          <h1 className="text-xl font-semibold text-s_textPrimary mt-6">Jane Doe</h1>
          <h2 className="font-medium text-s_textSecondary">Founder</h2>
        </Card>
        <Card>
          <LOGO1 className="w-8 h-8" />
          <p className="font-medium text-s_textSecondary mt-6">
            StratikUI has revolutionized my design workflow. The intuitive interface makes it easy to create sleek,
            modern designs without compromising on functionality.
          </p>
          <h1 className="text-xl font-semibold text-s_textPrimary mt-6">John Doe</h1>
          <h2 className="font-medium text-s_textSecondary">CEO</h2>
        </Card>

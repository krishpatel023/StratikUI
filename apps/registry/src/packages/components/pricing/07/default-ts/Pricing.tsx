  ...
  return (
    <table className="w-full text-foreground">
      <colgroup>
        <col className="w-1/4" />
        <col
          className={twMerge("w-1/4", popular == 0 && backgroundOfPopular)}
        />
        <col
          className={twMerge("w-1/4", popular == 1 && backgroundOfPopular)}
        />
        <col
          className={twMerge("w-1/4", popular == 2 && backgroundOfPopular)}
        />
      </colgroup>
      <thead>
        <tr>
      ...
      <tbody>
        ...
        <tr className="h-10">
          ...
          <td
            className={twMerge(
              "rounded-b-xl",
              popular == 0 && backgroundOfPopular
            )}
          ></td>
          <td
            className={twMerge(
              "rounded-b-xl",
              popular == 1 && backgroundOfPopular
            )}
          ></td>
          <td
            className={twMerge(
              "rounded-b-xl",
              popular == 2 && backgroundOfPopular
            )}
          ></td>
        </tr>
      </tbody>

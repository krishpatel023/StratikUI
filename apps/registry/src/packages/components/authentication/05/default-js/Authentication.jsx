...
import { Input as PasswordToggle } from "@registry/packages/primitives/input-text/06/react_aria-js/Input";
    ...
    <div className="flex h-[48rem] w-full items-center justify-center ">
      <div className="relative h-full w-[40%] flex-col items-center justify-center hidden @lg:flex">
        <div className="flex w-3/4 flex-col gap-4">
          <h1 className="text-5xl font-bold text-primary-foreground">Welcome to the tech community.</h1>
          <span className="text-2xl font-normal text-secondary-foreground">
            {"Sign up to start creating your dream website. Let's kickstart your development."}
          </span>
        </div>
        <Background />
      </div>
      <div className="flex h-full w-full @lg:w-[60%] items-center justify-center bg-background">
        <form className="w-[50%] min-w-80" onSubmit={handleSubmit}>
          <div className="flex w-full flex-col gap-6">
            <span className="flex gap-6 @md:gap-4 flex-col @md:flex-row">
              <Input label="First Name" placeholder="First Name" className="h-12" />
              <Input label="Last Name" placeholder="Last Name" className="h-12" />
            </span>
            <Input label="Email" placeholder="you@email.com" className="h-12 " />
            <PasswordToggle label="Password" placeholder="Password" className="h-12 " state="default" />
          </div>
          ...
          <div className="w-full mt-6 flex items-center justify-between">
            <div className="min-h-[1px] w-[43%] bg-outline-secondary" />
            <span className="text-sm font-medium text-secondary-foreground">OR</span>
            <div className="min-h-[1px] w-[43%] bg-outline-secondary" />
          </div>

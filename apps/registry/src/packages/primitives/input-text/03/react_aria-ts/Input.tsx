...
export function Input({ state = "default", label, isRequired, isReadOnly, icon, className, ...props }: InputProps) {
  return (
    <Field
      name={props.name}
      type={props.type}
    ...
    >
      ...
      <div className="relative">
        ...
        <InputBox className={twMerge("pl-12", className as string)} {...props} />
      </div>

...
import { Stepper, Step } from "@registry/packages/primitives/steppers/02/default-js/Stepper";
...
export default function StepperImplementation() {
  ...
  return (
    <div className="flex flex-col justify-center items-center gap-10">
      <div className="flex gap-4 flex-col md:flex-row items-center justify-center relative">

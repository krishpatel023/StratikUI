...
export const Header = () => {
  ...
  return (
    <div className="sticky top-0 z-[999]">
      ...
      <div
        className={twMerge(
          `w-full  h-16 flex justify-between px-2 sm:px-6 md:px-10 items-center border-b dark:border-neutral-900`,
          "bg-neutral-100/95 dark:bg-neutral-950/95 backdrop-blur supports-[backdrop-filter]:bg-neutral-200/50 sm:supports-[backdrop-filter]:bg-neutral-200/40 dark:supports-[backdrop-filter]:bg-neutral-950/99 sm:dark:supports-[backdrop-filter]:bg-neutral-950/90"
        )}
      >
        <Link
          href="/"

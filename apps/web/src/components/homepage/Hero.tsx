    ...
    <div className="w-full h-[calc(100vh-4rem)] relative">
      <div className="w-full h-full flex flex-col justify-center items-center gap-4 text-center px-6">
        ...
        <p className="hidden md:block text-xl text-neutral-700 dark:text-neutral-400 max-w-[60rem]">
          Explore our extensive collection of over 100+ Open Source components, hooks, and primitives designed in
          default along with accessible React Aria variant, to ensure accessibility without compromising on style or
          performance.
        </p>
        <p className="md:hidden text-md text-neutral-700 dark:text-neutral-400 max-w-[90%]">
          100+ Open Source components, hooks, and primitives designed in default along with accessible React Aria
          variant.
        </p>
        <ShineLink

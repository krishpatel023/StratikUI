  ...
  return (
    <div className="flex gap-6 items-center">
      <div className="border border-outline-secondary shadow w-max rounded-lg p-1 bg-white/5 group-data-[visible=true]/bento-card:animate-buttonPress group-hover/bento-card:animate-buttonPress transition-all duration-200 delay-300 relative">
        ...
        <div className="min-h-full min-w-full transition-all duration-200 delay-300  group-data-[visible=true]/bento-card:bg-green-500 group-hover/bento-card:bg-green-500 absolute top-0 left-0 rounded-xl opacity-90 blur-[10px] -z-50"></div>
      </div>
    </div>
  );
}

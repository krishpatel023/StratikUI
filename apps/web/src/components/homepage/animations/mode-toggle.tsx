  ...
  return (
    <div className="flex gap-4 justify-center items-center">
      <div className="flex gap-4 border border-outline rounded-full h-[3.125rem] w-24 justify-center items-center relative bg-neutral-100 dark:bg-neutral-900/90">
        ...
        <div className="absolute top-1 left-1 bg-neutral-300 dark:bg-neutral-700 border border-neutral-400 dark:border-neutral-950 min-h-10 min-w-10 rounded-full group-data-[visible=true]/bento-card:translate-x-[2.85rem] group-hover/bento-card:translate-x-[2.85rem] transition-all duration-500 delay-300"></div>
      </div>

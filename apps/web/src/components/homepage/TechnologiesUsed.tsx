  ...
  return (
    <div className="w-full mt-40 h-80 flex flex-col justify-center items-center gap-12 px-6">
      <div className="flex justify-center items-center gap-8">
        <div className="hidden md:block min-w-80 min-h-[2px] bg-gradient-to-l from-neutral-400 via-neutral-300  dark:from-neutral-700 dark:via-neutral-600 to-transparent rounded-full" />
        <GradientText className="text-xl font-medium">Technologies Used</GradientText>
        <div className="hidden md:block min-w-80 min-h-[2px] bg-gradient-to-r from-neutral-400 via-neutral-300 dark:from-neutral-700 dark:via-neutral-600  to-transparent rounded-full" />
      </div>
...
const Icons = {
  ...
  nextjs: (props: IconProps) => (
    <svg height="200" width="200" viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg" {...props}>

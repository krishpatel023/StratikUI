...
export const Data = {
    ...
    tags: [],
    description: "This is a testimonial section which can be used for displaying tweets for the products.",
...
<ImportsWrapper>
import {Testimonial} from "@/packages/components/testimonials/Testimonials_1"

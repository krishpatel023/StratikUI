inserimport { Implementation, Preview, Display, TechnologyUsed, Wrapper, Header, ImportsWrapper } from "@/components/mdx/MDXServerImports"
import { CodeBlock, ResizableDisplay } from "@/components/mdx/MDXClientImports"

export const Data = {
    name: "Basic Sign Up expanded version",
    tags: [],
    description: "This is a basic sign up component built using react-aria and is styled using tailwind css and twMerge. It is simple yet functional. The purpose of it is to provide you basic UI that you can modify to fit your needs.",
...
<ImportsWrapper>
import { AuthenticationImplementation } from "@/packages/components/authentication/Authentication_1_SignUp_2";

...
export const Data = {
    ...
    tags: [],
    description: "This is a detailed file upload component that can be used to upload files. It supports drag and drop, file selection, file type validation, and file size limit.",
...
<ImportsWrapper>
import {FileUploadImplementation} from "@/packages/components/file_upload/File_Upload_3"

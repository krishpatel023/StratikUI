...
export const Data = {
    ...
    tags: [],
    description: "This is a detailed footer component which features a clean and straightforward design, making it easy for users to find the information they need without any distractions.",
...
<ImportsWrapper>
import {FooterImplementation} from "@/packages/components/footers/Footer_3"

...
export const Data = {
    ...
    tags: [],
    description: "This is similar to the header blocks of above but with animation",
...
<ImportsWrapper>
import {HeaderBlocksImplementation} from "@/packages/primitives/header_blocks/HeaderBlocks_3"

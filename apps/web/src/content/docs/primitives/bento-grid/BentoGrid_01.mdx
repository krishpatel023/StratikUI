...
export const Data = {
  name: "Bento Grid",
  description: "A bento grid is a visually appealing layout design inspired by Japanese bento boxes. It organizes content into a grid of rectangular sections, each containing distinct elements or information, creating a clean and organized presentation.",
...
import { BentoGridImplementation } from "@/packages/primitives/bento_grid/BentoGrid";

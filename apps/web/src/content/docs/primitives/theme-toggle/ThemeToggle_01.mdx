...
export const Data = {
    ...
    tags: [],
    description: "The ToggleButton component is a customizable button designed for toggling states, such as themes or other options. It is accessible and customizable, allowing you to create a theme toggle group with ease.",
...
<ImportsWrapper>
import {ThemeToggleImplementation} from "@/packages/primitives/theme_toggles/Theme_Toggle_1"

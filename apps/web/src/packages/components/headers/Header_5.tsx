...
import { CommandPalette } from "@/packages/primitives/command_palette/Command_Palette";
      ...
      >
        ...
        <span className="gap-8 items-center justify-center hidden @lg:flex">
          ...
          <GradientBackground className="z-10">
            <button className="relative z-20 bg-white text-black dark:bg-black dark:text-white py-2 @md:px-4 rounded-lg hidden @md:block">
              Get Started
            </button>
          </GradientBackground>
        </span>
  ...
  return (
    ...
    >
      <div className="w-full">
        <HeaderComponent />
        <div className="min-h-[40rem] w-full flex justify-center items-center text-black dark:text-white">
          <h1>Content</h1>
        </div>
      </div>
    </div>

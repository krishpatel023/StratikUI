...
<CodeBlock variant="default-header">
...
<TechnologyUsed technologies={["tailwind-merge","react-aria-components"]} />
<CodeBlock variant="header-with-animated-dropdowns">
...
<TechnologyUsed technologies={["framer-motion","tailwind-merge"]} />
<CodeBlock variant="hanging-header-with-blurred-background">
...
<TechnologyUsed technologies={["tailwind-merge","react-aria-components"]} />
<CodeBlock variant="header-with-animation-on-scroll">
...
<TechnologyUsed technologies={["tailwind-merge","react-aria-components"]} />
<CodeBlock variant="header-with-search-bar-and-animations">

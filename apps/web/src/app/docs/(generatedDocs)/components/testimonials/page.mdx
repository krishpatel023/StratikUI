...
```default|js|testimonial.jsx
import { Carousel } from "@/packages/primitives/carousel/01/default-js/carousel";
import { SimpleDashedBackground } from "@/ui/DashedBackground";
import { twMerge } from "tailwind-merge";
...
```default|ts|testimonial.tsx
import { Carousel } from "@/packages/primitives/carousel/01/default-ts/carousel";
import { SimpleDashedBackground } from "@/ui/DashedBackground";
import { twMerge } from "tailwind-merge";

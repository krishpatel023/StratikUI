...
{/*
// ------------------------------------------------------------------------------------
    //	The text below is generated from "@/registry/components/testimonials/01"
//------------------------------------------------------------------------------------
*/}

<Wrapper>
<Title>Testimonial Section with Cards</Title>
...
export const Components_testimonials_01 = lazy(() => import("@registry/packages/components/testimonials/01/default-ts/example"));


<Suspense fallback={<Skeleton className="h-[800px] rounded-lg" />}>
<ResizableDisplay>
<Components_testimonials_01 />
</ResizableDisplay>
</Suspense>

</Preview><Implementation>
<TechnologyUsed technologies={[]} />
<CodeBlock variant="testimonial-section-with-cards">
...
{/*
// ------------------------------------------------------------------------------------
    //	The text below is generated from "@/registry/components/testimonials/02"
//------------------------------------------------------------------------------------
*/}

<Wrapper>
<Title>Grid Testimonial Cards</Title>
...
export const Components_testimonials_02 = lazy(() => import("@registry/packages/components/testimonials/02/default-ts/example"));


<Suspense fallback={<Skeleton className="h-[800px] rounded-lg" />}>
<ResizableDisplay>
<Components_testimonials_02 />
</ResizableDisplay>
</Suspense>

</Preview><Implementation>
<TechnologyUsed technologies={["tailwind-merge"]} />
<CodeBlock variant="grid-testimonial-cards">
...
{/*
// ------------------------------------------------------------------------------------
    //	The text below is generated from "@/registry/components/testimonials/03"
//------------------------------------------------------------------------------------
*/}
...
export const Components_testimonials_03 = lazy(() => import("@registry/packages/components/testimonials/03/default-ts/example"));


<Suspense fallback={<Skeleton className="h-[800px] rounded-lg" />}>
<ResizableDisplay>
<Components_testimonials_03 />
</ResizableDisplay>
</Suspense>

</Preview><Implementation>
<TechnologyUsed technologies={["tailwind-merge"]} />
<CodeBlock variant="testimonial-carousel">
...
{/*
// ------------------------------------------------------------------------------------
    //	The text below is generated from "@/registry/components/testimonials/04"
//------------------------------------------------------------------------------------
*/}

<Wrapper>
<Title>Testimonial Panel</Title>
### This testimonial panel helps displaying the client testimonials in a very efficient and an eye catching way.
<WrapperToggle>
<Preview>

export const Components_testimonials_04 = lazy(() => import("@registry/packages/components/testimonials/04/default-ts/example"));


<Suspense fallback={<Skeleton className="h-[800px] rounded-lg" />}>
<ResizableDisplay>
<Components_testimonials_04 />
</ResizableDisplay>
</Suspense>

</Preview><Implementation>
<TechnologyUsed technologies={[]} />
<CodeBlock variant="testimonial-panel">

...
{/*
// ------------------------------------------------------------------------------------
//	The text below is generated from apps/web/src/content/docs/components/footers/Footer_01.mdx
// ------------------------------------------------------------------------------------
*/}
...
export const FooterImplementation_components_footers_footer_01 = React.lazy(() =>
	import('@/packages/components/footers/Footer_1')
		.then((mod) => ({
			default: mod.FooterImplementation
	}))
);
...
<ResizableDisplay>
<FooterImplementation_components_footers_footer_01 />
</ResizableDisplay>
</Suspense>
...
{/*
// ------------------------------------------------------------------------------------
//	The text below is generated from apps/web/src/content/docs/components/footers/Footer_02.mdx
// ------------------------------------------------------------------------------------
*/}
...
### This is the basic footer component wit h theme toggle that features a clean and straightforward design, making it easy for users to find the information they need without any distractions.





export const FooterImplementation_components_footers_footer_02 = React.lazy(() =>
	import('@/packages/components/footers/Footer_2')
		.then((mod) => ({
			default: mod.FooterImplementation
	}))
);
...
<Suspense fallback={<Skeleton className="h-[800px] rounded-lg" />}>
<ResizableDisplay>
<FooterImplementation_components_footers_footer_02 />
</ResizableDisplay>
</Suspense>
...
{/*
// ------------------------------------------------------------------------------------
//	The text below is generated from apps/web/src/content/docs/components/footers/Footer_03.mdx
// ------------------------------------------------------------------------------------
*/}
...
# Detailed Footer
### This is a detailed footer component which features a clean and straightforward design, making it easy for users to find the information they need without any distractions.





export const FooterImplementation_components_footers_footer_03 = React.lazy(() =>
	import('@/packages/components/footers/Footer_3')
		.then((mod) => ({
			default: mod.FooterImplementation
	}))
);
...
<Suspense fallback={<Skeleton className="h-[800px] rounded-lg" />}>
<ResizableDisplay>
<FooterImplementation_components_footers_footer_03 />
</ResizableDisplay>
</Suspense>

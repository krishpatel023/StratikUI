...
{/*
// ------------------------------------------------------------------------------------
//	The text below is generated from apps/web/src/content/docs/components/brand-associations/BrandWall_01.mdx
// ------------------------------------------------------------------------------------
*/}
...
export const BrandWallImplementation_components_brand_associations_brandwall_01 = React.lazy(() =>
	import('@/packages/components/brand_associations/Brand_Wall_1')
		.then((mod) => ({
			default: mod.BrandWallImplementation
	}))
);
...
<ResizableDisplay>
<BrandWallImplementation_components_brand_associations_brandwall_01/>
</ResizableDisplay>
</Suspense>

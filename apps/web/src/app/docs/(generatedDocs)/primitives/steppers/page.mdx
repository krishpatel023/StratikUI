...
<CodeBlock variant="default-stepper">
...
<TechnologyUsed technologies={["tailwind-merge"]} />
<CodeBlock variant="indicating-stepper">
...
<TechnologyUsed technologies={["tailwind-merge"]} />
<CodeBlock variant="vertical-stepper">
...
<TechnologyUsed technologies={["tailwind-merge"]} />
<CodeBlock variant="boxed-stepper">
...
<CodeBlock variant="stepper-with-progress-bar">
...
<CodeBlock variant="detailed-stepper">

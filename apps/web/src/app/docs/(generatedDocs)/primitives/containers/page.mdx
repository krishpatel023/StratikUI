...
<CodeBlock variant="gradient-background">
...
<TechnologyUsed technologies={["tailwind-merge"]} />
<CodeBlock variant="gradient-border">
...
<TechnologyUsed technologies={["tailwind-merge"]} />
<CodeBlock variant="spotlight-container">
...
<CodeBlock variant="container-with-rotating-border">
...
<TechnologyUsed technologies={["tailwind-merge"]} />
<CodeBlock variant="container-with-conic-gradient-background">
...
<TechnologyUsed technologies={["tailwind-merge"]} />
<CodeBlock variant="glass-/-blurred-background-container">
...
{/*
// ------------------------------------------------------------------------------------
    //	The text below is generated from "@/registry/primitives/containers/07"
//------------------------------------------------------------------------------------
*/}

<Wrapper>
<Title>Mouse Tracking Gradient Container</Title>
### A React component that displays a moving gradient effect based on the mouse position within the container.

<WrapperToggle >
<Preview>

export const Primitives_containers_07 = lazy(() => import("@registry/packages/primitives/containers/07/default-ts/example"));


<Suspense fallback={<Skeleton className="h-60 rounded-lg" />}>
<Display>
<Primitives_containers_07 />
</Display>
</Suspense>
...
<TechnologyUsed technologies={["tailwind-merge"]} />
<CodeBlock variant="mouse-tracking-gradient-container">

...
<CodeBlock variant="default-header-block">
...
<TechnologyUsed technologies={["tailwind-merge","react-aria-components"]} />
<CodeBlock variant="continuous-header-blocks">
...
<TechnologyUsed technologies={["framer-motion","tailwind-merge","react-aria-components"]} />
<CodeBlock variant="continuous-header-blocks-with-animation">

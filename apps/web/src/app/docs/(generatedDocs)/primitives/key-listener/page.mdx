...
{/*
// ------------------------------------------------------------------------------------
//	The text below is generated from apps/web/src/content/docs/primitives/key-listener/KeyListener_01.mdx
// ------------------------------------------------------------------------------------
*/}
...
# Key Listner with Icon Display
### This component is a combination of helper functions that can be used to create a key listener with icons that represent the key that needs to be pressed to trigger the callback function.





export const KeyListenerImplementation_primitives_key_listener_keylistener_01 = React.lazy(() =>
	import('@/packages/primitives/key_listener/KeyListener')
		.then((mod) => ({
			default: mod.KeyListenerImplementation
	}))
);
...
<Display>
<KeyListenerImplementation_primitives_key_listener_keylistener_01 />
</Display>
</Suspense>

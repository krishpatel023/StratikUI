...
{/*
// ------------------------------------------------------------------------------------
    //	The text below is generated from "@/registry/primitives/key-listener/01"
//------------------------------------------------------------------------------------
*/}
...
export const Primitives_key_listener_01 = lazy(() => import("@registry/packages/primitives/key-listener/01/default-ts/example"));


<Suspense fallback={<Skeleton className="h-60 rounded-lg" />}>
<Display>
<Primitives_key_listener_01 />
</Display>
</Suspense>
...
<CodeBlock variant="key-listener">

...
{/*
// ------------------------------------------------------------------------------------
    //	The text below is generated from "@/registry/primitives/avatars/01"
//------------------------------------------------------------------------------------
*/}
...
export const Primitives_avatars_01 = lazy(() => import("@registry/packages/primitives/avatars/01/default-ts/example"));


<Suspense fallback={<Skeleton className="h-60 rounded-lg" />}>
<Display>
<Primitives_avatars_01 />
</Display>
</Suspense>
...
<CodeBlock variant="default-avatar">

```default|js|Avatar.jsx
"use client";
...
{/*
// ------------------------------------------------------------------------------------
    //	The text below is generated from "@/registry/primitives/avatars/02"
//------------------------------------------------------------------------------------
*/}
...
export const Primitives_avatars_02 = lazy(() => import("@registry/packages/primitives/avatars/02/default-ts/example"));


<Suspense fallback={<Skeleton className="h-60 rounded-lg" />}>
<Display>
<Primitives_avatars_02 />
</Display>
</Suspense>
...
<TechnologyUsed technologies={["tailwind-merge"]} />
<CodeBlock variant="avatar-with-icon">
...
import { AvatarWithIcon } from "@registry/packages/primitives/avatars/02/default-ts/Avatar";
import Dummy from "@registry/assets/Images/Image_2.jpg";
...
{/*
// ------------------------------------------------------------------------------------
    //	The text below is generated from "@/registry/primitives/avatars/03"
//------------------------------------------------------------------------------------
*/}
...
export const Primitives_avatars_03 = lazy(() => import("@registry/packages/primitives/avatars/03/default-ts/example"));


<Suspense fallback={<Skeleton className="h-60 rounded-lg" />}>
<Display>
<Primitives_avatars_03 />
</Display>
</Suspense>
...
<TechnologyUsed technologies={["tailwind-merge"]} />
<CodeBlock variant="avatar-stack">

...
{/*
// ------------------------------------------------------------------------------------
//	The text below is generated from apps/web/src/content/docs/primitives/drawer/Drawer_01.mdx
// ------------------------------------------------------------------------------------
*/}
...
# Default Drawer
### This is a default drawer component that can be used to display a sidebar on the left or right side of the screen.





export const DrawerImplementation_primitives_drawer_drawer_01 = React.lazy(() =>
	import('@/packages/primitives/drawer/Drawer_1')
		.then((mod) => ({
			default: mod.DrawerImplementation
	}))
);
...
<Display>
<DrawerImplementation_primitives_drawer_drawer_01 />
</Display>
</Suspense>

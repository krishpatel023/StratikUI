...
{/*
// ------------------------------------------------------------------------------------
//	The text below is generated from apps/web/src/content/docs/primitives/theme-toggle/ThemeToggle_01.mdx
// ------------------------------------------------------------------------------------
*/}
...
# Theme toggle group
### The ToggleButton component is a customizable button designed for toggling states, such as themes or other options. It is accessible and customizable, allowing you to create a theme toggle group with ease.





export const ThemeToggleImplementation_primitives_theme_toggle_themetoggle_01 = React.lazy(() =>
	import('@/packages/primitives/theme_toggles/Theme_Toggle_1')
		.then((mod) => ({
			default: mod.ThemeToggleImplementation
	}))
);
...
<Display>
<ThemeToggleImplementation_primitives_theme_toggle_themetoggle_01 />
</Display>
</Suspense>

...
<CodeBlock variant="default-input">
...
<TechnologyUsed technologies={["tailwind-merge","react-aria-components"]} />
<CodeBlock variant="default-input-with-states">
...
<TechnologyUsed technologies={["tailwind-merge","react-aria-components"]} />
<CodeBlock variant="input-with-icon-on-the-left">
...
<TechnologyUsed technologies={["tailwind-merge","react-aria-components"]} />
<CodeBlock variant="input-with-icon-on-the-right">
...
export default function InputWithRightIcon() {
  return (
    <div className="w-full flex flex-col items-center gap-6">
      <Input name="Name" type="text" placeholder="Name" label="Name" icon={<Icon />} />
    </div>
  );
}

const Icon = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="1.2em" height="1.2em" viewBox="0 0 1024 1024" {...props}>
    <title>Icon</title>
    <path
      fill="currentColor"
...
<TechnologyUsed technologies={["tailwind-merge","react-aria-components"]} />
<CodeBlock variant="floating-label-animation-in-input-fields">
...
<TechnologyUsed technologies={["tailwind-merge","react-aria-components"]} />
<CodeBlock variant="input-with-password-toggle">
...
<TechnologyUsed technologies={["tailwind-merge","react-aria-components"]} />
<CodeBlock variant="default-lined-input">
...
<TechnologyUsed technologies={["tailwind-merge","react-aria-components"]} />
<CodeBlock variant="lined-input-with-states">
...
<TechnologyUsed technologies={["tailwind-merge","react-aria-components"]} />
<CodeBlock variant="default-input-with-label-inside">
...
<TechnologyUsed technologies={["tailwind-merge","react-aria-components"]} />
<CodeBlock variant="input-with-label-inside-and-states">

...
{/*
// ------------------------------------------------------------------------------------
//	The text below is generated from apps/web/src/content/docs/primitives/input-otp/Input_OTP_01.mdx
// ------------------------------------------------------------------------------------
*/}
...
<Display>
    <OTPImplementation_primitives_input_otp_input_otp_01 />
</Display>
</Suspense>

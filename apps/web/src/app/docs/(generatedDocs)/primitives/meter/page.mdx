...
{/*
// ------------------------------------------------------------------------------------
//	The text below is generated from apps/web/src/content/docs/primitives/meter/Meter_01.mdx
// ------------------------------------------------------------------------------------
*/}
...
export const MeterImplementation_primitives_meter_meter_01 = React.lazy(() =>
	import('@/packages/primitives/meter/Meter_1')
		.then((mod) => ({
			default: mod.MeterImplementation
	}))
);
...
<Display>
<MeterImplementation_primitives_meter_meter_01 />
</Display>
</Suspense>

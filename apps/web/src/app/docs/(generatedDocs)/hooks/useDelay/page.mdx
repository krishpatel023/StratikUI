...
{/*
// ------------------------------------------------------------------------------------
//	The text below is generated from apps/web/src/content/docs/hooks/useDelay/useDelay.mdx
// ------------------------------------------------------------------------------------
*/}
...
export const Helper_hooks_usedelay_usedelay = React.lazy(() =>
	import('@/packages/hooks/useDelay/Demo.tsx')
		.then((mod) => ({
			default: mod.Helper
	}))
);
...
<Display>
    <Helper_hooks_usedelay_usedelay/>
</Display>
</Suspense>
</Wrapper>
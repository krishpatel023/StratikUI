...
{/*
// ------------------------------------------------------------------------------------
//	The text below is generated from apps/web/src/content/docs/hooks/useArtificialLoader/useArtificialLoader.mdx
// ------------------------------------------------------------------------------------
*/}
...
export const Loader_hooks_useartificialloader_useartificialloader = React.lazy(() =>
	import('@/packages/hooks/useArtificialLoader/Demo.tsx')
		.then((mod) => ({
			default: mod.Loader
	}))
);
...
<Display>
    <Loader_hooks_useartificialloader_useartificialloader/>
</Display>
</Suspense>
</Wrapper>
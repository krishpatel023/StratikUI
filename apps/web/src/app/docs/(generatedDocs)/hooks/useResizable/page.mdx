...
{/*
// ------------------------------------------------------------------------------------
//	The text below is generated from apps/web/src/content/docs/hooks/useResizable/useResizable.mdx
// ------------------------------------------------------------------------------------
*/}
...
export const Demo_hooks_useresizable_useresizable = React.lazy(() =>
	import('@/packages/hooks/useResizable/Demo.tsx')
		.then((mod) => ({
			default: mod.Demo
	}))
);
...
const useResizable = (
  ...
  const handleMove = (e: TouchEvent | MouseEvent) => {
    ...
    else if (activeHandle === "bottom" || activeHandle === "top") resizableRef.current.style.height = `${heightFinal}px`;
...
<Display>
    <Demo_hooks_useresizable_useresizable/>
</Display>
</Suspense>
</Wrapper>
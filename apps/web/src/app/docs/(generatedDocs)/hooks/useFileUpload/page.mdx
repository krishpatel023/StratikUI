...
{/*
// ------------------------------------------------------------------------------------
//	The text below is generated from apps/web/src/content/docs/hooks/useFileUpload/useFileUpload.mdx
// ------------------------------------------------------------------------------------
*/}
...
export const Demo_hooks_usefileupload_usefileupload = React.lazy(() =>
	import('@/packages/hooks/useFileUpload/Demo.tsx')
		.then((mod) => ({
			default: mod.Demo
	}))
);
...
<Display>
    <Demo_hooks_usefileupload_usefileupload/>
</Display>
</Suspense>
</Wrapper>
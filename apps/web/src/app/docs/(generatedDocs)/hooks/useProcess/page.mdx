...
{/*
// ------------------------------------------------------------------------------------
//	The text below is generated from apps/web/src/content/docs/hooks/useProcess/useProcess.mdx
// ------------------------------------------------------------------------------------
*/}
...
export const Demo_hooks_useprocess_useprocess = React.lazy(() =>
	import('@/packages/hooks/useProcess/Demo.tsx')
		.then((mod) => ({
			default: mod.Demo
	}))
);
...
<Display>
    <Demo_hooks_useprocess_useprocess/>
</Display>
</Suspense>
</Wrapper>
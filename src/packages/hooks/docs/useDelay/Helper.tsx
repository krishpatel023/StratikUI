...
import useDelay from "../../code/useDelay";
...
export const DemoStrTsx = `export function Demo() {
  ...
  // This way you can use it with async-await or .then // [!code highlight]
  const handleDelay = async () => { // [!code highlight]
    await delay(2000); // [!code highlight]
    setActive(true); // [!code highlight]
  }; // [!code highlight]

  // This way you can use it without async-await or .then // [!code highlight]
  const handleDelayWithAction = () => { // [!code highlight]
    delay(2000, () => { // [!code highlight]
      setActive(true); // [!code highlight]
    }); // [!code highlight]
  }; // [!code highlight]

  const handleClearDelay = () => {
    clearDelay(); // [!code highlight]
  };

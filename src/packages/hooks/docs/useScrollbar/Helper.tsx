...
import useScrollbar from "../../code/useScrollbar";
...
export const DemoStringTsx = `export const Demo = () => {
  // Will provide the information of main direction and scroll position
  const { directionX, directionY, scrollPosition } = useScrollbar(); // [!code highlight]
...
export const DemoStringJsx = `export const Demo = () => {
  // Will provide the information of main direction and scroll position
  const { directionX, directionY, scrollPosition } = useScrollbar(); // [!code highlight]

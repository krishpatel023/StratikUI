...
function InputText({
  ...
  return (
    <div>
      ...
      <input
        type="text"
        className="mt-1 w-full bg-transparent text-s_textPrimary placeholder:text-s_textSecondary py-2 px-4 rounded-md border-[1px] border-s_primary focus:border-s_accent focus:outline-none focus:ring-2"
        //ADD FOR DISABLED
...
const Data: DataDescription = {
  ...
  description: "This is a text input with label",

  ...
  return (
    <div className="w-full h-full flex justify-center items-center flex-col gap-10">
      <div>
        ...
        <HighlightGroup className="h-full">
          <HighlighterItem className="rounded-full">
            <button className="px-8 py-2 text-s_textPrimary">
      ...
      <div>
        ...
        <HighlightGroup className="h-full ">
          <HighlighterItem>
            <div className="min-h-80 min-w-80"></div>
          </HighlighterItem>
        </HighlightGroup>
      </div>
      <div>
        <ArrowHeading text="Multiple/Group Container" className="mb-4" />
        <HighlightGroup className="h-full flex gap-6 flex-wrap justify-center items-center">
          <HighlighterItem>
            <div className="min-h-80 min-w-80"></div>
          </HighlighterItem>
          <HighlighterItem>
...
const Data: DataDescription = {
  ...
  description: "this will not look great on small sized containers",

...
export function ImplementDropdown() {
  const [position, setPosition] = useState<
    "top-left" | "top-right" | "bottom-left" | "bottom-right"
  >("top-left");
  return (
    <>
      <div className="absolute top-0 left-0 text-s_textPrimary flex flex-col gap-4 justify-center items-center px-4 py-2 ">
        <h1>Control Panel </h1>

        <h1>Position : {position} </h1>
        <span className="flex justify-center items-center flex-col gap-4 mb-60">
          <button
            className="rounded border border-neutral-200 dark:border-neutral-700 bg-neutral-200 dark:bg-neutral-900 py-1 px-4 text-s_textPrimary"
      ...
      <Dropdown label={<h1>Open Dropdown</h1>} direction={position}>

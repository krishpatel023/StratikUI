  ...
  return (
    <div className="flex justify-center items-center gap-4 w-full ">
      <ResizeBoundingElement
        ...
        className="h-80 w-[35rem] max-w-[35rem] bg-primary flex"
      >
        <ResizableContainer
          minWidth={100}
          minHeight={100}
        ...
        <div className="w-full h-full bg-accent text-accent-foreground text-center flex justify-center items-center px-2">
          <h1>

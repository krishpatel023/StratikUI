...
export function Mode() {
  ...
  return (
    <div className="flex gap-3">
      <button
        className={twMerge(
          "h-8 w-8 rounded-full flex justify-center items-center hover:bg-neutral-100 dark:hover:bg-neutral-800 dark:text-white transition-all duration-300 ease-linear data-[clicked=true]:scale-[0.90]",
          theme === "light" &&
            "border-2 border-blue-600 bg-blue-100 hover:bg-blue-100 dark:bg-blue-600/40 dark:hover:bg-blue-600/40 dark:border-blue-600"
        )}
        data-clicked={theme === "light" && clicked}
      ...
      <button
        ...
        data-clicked={theme === "dark" && clicked}
      ...
      <button
        ...
        data-clicked={theme === "system" && clicked}

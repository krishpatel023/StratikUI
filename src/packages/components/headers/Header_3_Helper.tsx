...
const AnimatedButton = () => {
  ...
  return (
    <button
      className="relative bg-neutral-950 dark:bg-neutral-200 text-s_textComplementary w-full @md:w-auto py-2 @md:px-4 rounded-full flex justify-center items-center overflow-hidden group"
      onMouseEnter={handleMouseEnter}
      onMouseLeave={handleMouseLeave}
    >
      ...
      <div
        className="min-w-60 min-h-60 absolute top-full rounded-full bg-neutral-100 dark:bg-neutral-900"
        ref={scope}
      ></div>
    </button>
  );

...
export const useClickOutsideStringTsx = `import { useEffect, RefObject } from "react";
...
export const useClickOutsideStringJsx = `import { useEffect, RefObject } from "react";

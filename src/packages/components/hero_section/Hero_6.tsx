...
function Hero() {
  return (
    <div className="w-full min-h-screen overflow-hidden flex flex-col @lg:flex-row justify-center items-center bg-s_background relative">
...
const HeroData: DataDescription = {
  name: "Hero Section brand association with minor change",
  description:
    "This is a hero section with brand assosiations with different small screen view",

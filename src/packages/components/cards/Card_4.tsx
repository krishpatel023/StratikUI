...
function Card() {
  return (
    <div className="w-80 rounded-lg flex flex-col justify-center gap-3  bg-white dark:bg-black text-s_textPrimary border-[1px] shadow-sm border-neutral-300 dark:border-neutral-600">
      <div className="w-full flex items-center py-6 px-6 bg-neutral-100 dark:bg-neutral-800 rounded-t-[inherit]">
        <h1>Featured</h1>
      </div>

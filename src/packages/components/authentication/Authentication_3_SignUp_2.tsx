...
export function SignIn() {
  ...
  return (
    <div className="flex h-[48rem] w-full items-center justify-center relative">
      <Background />
      <div className="flex flex-col py-8 px-8 w-full @md:w-[30rem] h-full @md:h-auto items-center justify-center bg-white/30 @md:border border-neutral-300 dark:border-neutral-900 rounded-lg dark:bg-black/30">

...
export function SignIn() {
  ...
  return (
    <div className="flex h-[48rem] w-full items-center justify-center relative">
      <Background />
      <div className="flex flex-col py-8 px-8 w-full h-full @md:h-auto @md:w-[25rem] items-center justify-center bg-white/30 border-0 @md:border border-neutral-300 dark:border-neutral-900 rounded-lg dark:bg-black/30">

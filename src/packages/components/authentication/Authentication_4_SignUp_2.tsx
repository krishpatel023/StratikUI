...
export function SignIn() {
  ...
  return (
    <div className="flex h-[48rem] w-full items-center justify-center relative">
      <Background />
      <div className="flex flex-col py-8 px-8 w-full h-full @md:h-auto @md:w-[30rem]  items-center justify-center bg-white/30 border-0 @md:border border-neutral-300 dark:border-neutral-900 rounded-lg dark:bg-black/30">
        ...
        <div className="flex w-full flex-col gap-4">
          <span className="flex gap-6 @md:gap-4 flex-col @md:flex-row">
            <InputText
              ...
              state="default"
              className="h-12 border-neutral-300 dark:border-neutral-800/60 border-[2px]"
            />
            <InputText
              label="Last Name"
        ...
        <div className="w-full mt-6 flex flex-col items-center justify-center gap-6">
          <Button
            className="w-full h-10 mt-auto px-4 py-2 text-black dark:text-white bg-white dark:bg-neutral-900 border border-neutral-300 dark:border-neutral-700 rounded-md relative z-[100] "
            clickedClassName="bg-neutral-100 dark:bg-neutral-700"
            textClassName="flex justify-center items-center flex-row gap-4"
          >
            <Google className="h-6 w-6 dark:text-white" />
          ...
          <Button
            ...
            textClassName="flex justify-center items-center flex-row gap-4"
          >
            <GitHubLogoIcon className="h-6 w-6 dark:text-white" />

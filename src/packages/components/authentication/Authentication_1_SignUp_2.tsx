...
export function SignIn() {
  ...
  return (
    <div className="flex h-[48rem] w-full items-center justify-center relative">
      <div className="flex flex-col py-8 px-8 w-full @md:w-[30rem] h-full @md:h-auto items-center justify-center bg-white @md:border border-neutral-300 dark:border-neutral-900 rounded-lg dark:bg-neutral-950">

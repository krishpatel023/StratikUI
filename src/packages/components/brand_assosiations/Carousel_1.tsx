...
function Carousel({ direction = "left" }) {
  ...
  return (
    <>
      <div className="max-w-[80rem] w-full h-28 inline-flex flex-nowrap overflow-x-hidden [mask-image:_linear-gradient(to_right,transparent_0,_black_128px,_black_calc(100%-128px),transparent_100%)]">
        <ul
          className={` flex items-center justify-center md:justify-start @md:[&_li]:mx-16 [&_li]:mx-8   ${animateInDirection}`}
        >
          {Logo.map((item, i) => (

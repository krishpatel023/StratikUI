...
export const CookiePrompt = () => {
  ...
  return (
    <>
      ...
      >
        <div className="max-w-[70rem] flex flex-col @md:flex-row gap-4 justify-between">
          <div className="w-3/4">
          ...
          <div className="flex gap-4 justify-start @md:justify-center items-center">
            <button
              className="py-2 px-3 rounded-md font-medium bg-black text-white dark:bg-white dark:text-black "
            ...
            <button
              ...
              className="py-2 px-3 rounded-md font-medium border-2 border-black dark:border-white dark:text-white "
            >
              Cookie Settings
            </button>
          </div>

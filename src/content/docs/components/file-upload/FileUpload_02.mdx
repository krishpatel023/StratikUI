...
export const Data = {
    name: "File Upload Component with Loader Animation",
    tags: [],
    description: "This is a file upload component with loader animation that can be used to upload files. It supports drag and drop, file selection, file type validation, and file size limit.",
...
<ImportsWrapper>
import {FileUploadImplementation} from "@/packages/components/file_upload/File_Upload_2"

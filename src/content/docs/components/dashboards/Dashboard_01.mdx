...
export const Data = {
    ...
    tags: [],
    description: "This is a simple dashboard with a header and a drawer. It is used to showcase the functionality of the components used in the dashboard along with providing a layout for the content.",
...
<ImportsWrapper>
import {DashboardImplementation} from "@/packages/components/dashboards/Dashboard_1"

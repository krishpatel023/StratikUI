...
export const Data = {
    ...
    tags: [],
    description: "This hero section can be used for websites that require images to display their credebility. It can also be used for landing pages. It contains various logos that are associated with the brand.",
...
<ImportsWrapper>
import {HeroSection} from "@/packages/components/hero_section/Hero_5"

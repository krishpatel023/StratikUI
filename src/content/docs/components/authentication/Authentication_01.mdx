...
export const Data = {
    name: "Basic Sign In",
    tags: [],
    description: "This is a basic sign in component built using react-aria and is styled using tailwind css and twMerge. It is simple yet functional. The purpose of it is to provide you basic UI that you can modify to fit your needs.",
...
<ImportsWrapper>
import { AuthenticationImplementation } from "@/packages/components/authentication/Authentication_1_SignIn";

...
{/*
// ------------------------------------------------------------------------------------
//	The text below is generated from src/content/docs/primitives/file-upload/FileUpload_01.mdx
// ------------------------------------------------------------------------------------
*/}
...
export const FileUploadImplementation_primitives_file_upload_fileupload_01 = React.lazy(() =>
	import('@/packages/primitives/file_upload/File_Upload_1')
		.then((mod) => ({
...
<Display>
<FileUploadImplementation_primitives_file_upload_fileupload_01/>
</Display>
</Suspense>
